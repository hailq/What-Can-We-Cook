...
#define kRecipeDirection @"instructions"
#define kIngredientRootTag @"ingredients"
#define kIngredientTag @"ingredient"
#define kIngredientAmount @"amount"
#define kIngredientType @"type"
#define kIngredientMeasure @"measure"

#define kBaseUrl @"http://serv11.divms.uiowa.edu/~ios5/connect/index.php"
#define kCommenUrl @"http://serv11.divms.uiowa.edu/~ios5/connect/comment.php"
